...
| `availabilityZones`                     | `array`        | No       | A list of availability zones denoting the zone in which the resources will be configured with. Note, not all resources and regions support availability zones.                                                                    |
