...
| `availabilityZones`                     | `array`        | Yes      | A list of availability zones denoting the zone in which the virtual machine should be deployed. Note, not all resources support multiple availability zones.                                                                      |
