...
resource networkInterface 'Microsoft.Network/networkInterfaces@2022-07-01' = [for i in range(0, 3): {
...
module associationMultipleVms '../main.bicep' = [for i in range(0, length(vmNameList)): {
